export const enum ResultCode {
  ...
  IM_ROBOT_CREATE_ROLE_ERROR = 401,
  ...
  UPDATE_EXT_DATA_FAIL_VERSION_IS_NOT_DEV = 1011,
  UPDATE_EXT_DATA_FAIL_NOT_EXIST_RESOURCE_URL = 1012,
...
export const codeMap: Record<ResultCode, string> = {
  ...
  [ResultCode.IM_ROBOT_CREATE_ROLE_ERROR]: '调用失败：该用户没有权限创建机器人',
  ...
  [ResultCode.UPDATE_EXT_DATA_FAIL_VERSION_IS_NOT_DEV]: '操作失败：版本必须处于开发状态',
  [ResultCode.UPDATE_EXT_DATA_FAIL_NOT_EXIST_RESOURCE_URL]: '操作失败：不存在源码包路径',
